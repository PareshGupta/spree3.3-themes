...
ActiveRecord::Schema.define(version: 20180121124821) do
  ...
  create_table "spree_themes", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.string "state"
  ...
  create_table "spree_themes_templates", id: :integer, force: :cascade, options: "ENGINE=InnoDB DEFAULT CHARSET=utf8" do |t|
    t.string "name"
    t.text "body"
    t.string "path"
    t.string "format"
